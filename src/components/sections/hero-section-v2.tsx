      ...
      <div className="flex-1 relative max-w-7xl mx-auto w-full px-6 pt-2 pb-20 flex flex-col lg:flex-row items-center z-10">
        ...
        <div className="w-full lg:w-1/2 relative mt-16 md:mt-24 lg:mt-0 h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] flex justify-center items-center">
          ...
          <div className="relative z-10 flex justify-center items-center h-full">
            {/* Phone outer shell — tilted */}
            <div className="relative w-[220px] sm:w-[260px] md:w-[290px] lg:w-[300px] drop-shadow-2xl rotate-[6deg]">
              {/* Phone body */}
              <div className="relative bg-zinc-900 rounded-[44px] p-[10px] shadow-[0_0_0_2px_#3f3f46,0_40px_100px_-10px_rgba(0,0,0,0.8)] border border-zinc-700">
                {/* Side buttons (decorative) */}
                <div className="absolute -left-[3px] top-[80px] w-[3px] h-8 bg-zinc-700 rounded-l-md"></div>
                <div className="absolute -left-[3px] top-[126px] w-[3px] h-10 bg-zinc-700 rounded-l-md"></div>
                <div className="absolute -left-[3px] top-[176px] w-[3px] h-10 bg-zinc-700 rounded-l-md"></div>
                <div className="absolute -right-[3px] top-[110px] w-[3px] h-14 bg-zinc-700 rounded-r-md"></div>
                {/* Screen bezel */}
                <div className="relative bg-black rounded-[36px] overflow-hidden aspect-[9/19.5]">
                  {/* Dynamic island */}
                  <div className="absolute top-3 left-1/2 -translate-x-1/2 w-[90px] h-[26px] bg-black rounded-full z-20 border border-zinc-800"></div>
                  {/* Video */}
                  <video
                    ref={videoRef}
                    src="https://res.cloudinary.com/dg1i3ew9w/video/upload/v1773928894/AQMSRvG4SH5lin8OcONk_Caqre4RaqJULxzJ7Km34qs14VG_cJ-YB5D6tmhDm51cvACQlkxcfizyqzVi_vfDP3xC_1_1_tfrx1o.mp4"
                    loop
                    playsInline
                    poster="https://res.cloudinary.com/dg1i3ew9w/video/upload/so_0,w_600/v1773928894/AQMSRvG4SH5lin8OcONk_Caqre4RaqJULxzJ7Km34qs14VG_cJ-YB5D6tmhDm51cvACQlkxcfizyqzVi_vfDP3xC_1_1_tfrx1o.jpg"
                  ...
                  {!isPlaying && (
                    <button
                      onClick={handlePlay}
                      className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-black/30 backdrop-blur-[2px] group"
                    >
                      <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-200">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" className="text-zinc-900 translate-x-0.5">
                          <polygon points="5 3 19 12 5 21 5 3" />
                        </svg>
                      </div>
                      <span className="mt-3 text-white text-xs font-semibold tracking-widest uppercase opacity-90">Watch Reel</span>
                    </button>
                  )}
                </div>
              </div>
